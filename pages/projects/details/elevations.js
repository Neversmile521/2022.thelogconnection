...
const ProjectExteriorElevationPage = () => {
  ...
  let filter = router.query.filter ? router.query.filter : "current";
  ...
  const PROJECTS_DETAILS_NAVBAR = [

    {
      ...
      href: `${PROJECTS_DETAILS_PATH.ELEVATION}?project=${projectCode}&filter=${filter}`,
    },
    {
      title: PROJECTS_DETAILS_CONST.FLOOR_PLAN_HEADER_LABEL,
      href: `${PROJECTS_DETAILS_PATH.FLOOR_PLAN}?project=${projectCode}&filter=${filter}`,
    },
    {
      title: PROJECTS_DETAILS_CONST.GALLERY_HEADER_LABEL,
      href: `${PROJECTS_DETAILS_PATH.GALLERY}?project=${projectCode}&filter=${filter}`,
    },
  ];
